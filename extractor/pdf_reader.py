...
LLM_PROVIDER = "none"
HF_TOKEN = None
HF_MODEL_ID = "google/gemma-2b-it" # On utilise Gemma, stable et ouvert
...
def structure_data_with_llm(text_content):
    ...
    payload = {
     ...
     # ... juste avant le bloc try ...
    print(f"DEBUG: Clé API utilisée : {HF_TOKEN[:5]}...{HF_TOKEN[-4:]}") # Affiche le début et la fin de la clé pour vérifier qu'elle est lue
